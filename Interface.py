...
class Menu(tk.Frame):
    def __init__(self, master):      
        ...
        tk.Label(row3, text="Max Sensor Rate (ppm)").pack(side="left", padx=5, pady=5)
        ...
        tk.Label(row5, text="Atrial Pulse Width (ms)").pack(side="left", padx=8, pady=5)
        AAIRAPW = tk.Scale(row5, from_=1, to=10, length=300, tickinterval=1, orient=tk.HORIZONTAL)
        AAIRAPW.pack(side="left", padx=5, pady=5)
        tk.Label(row6, text="Atrial Sensitivity (mV)").pack(side="left", padx=13, pady=5)
        ...
        tk.Label(row6, text="Activity Threshold").pack(side="left", padx=5, pady=5)
        ...
        tk.Label(row1, text="Ventricular Sensitivity (mV)").pack(side="left", padx=5, pady=5)
        VVIRVS = tk.Scale(row1, from_=0.5, to=3.3, resolution=0.1, length=300, tickinterval=0.3, orient=tk.HORIZONTAL)
        VVIRVS.pack(side="left", padx=5, pady=5)
        tk.Label(row2, text="VRP (ms)").pack(side="left", padx=52, pady=5)
        VVIRVRP = tk.Scale(row2, from_=150, to=500, length=300, tickinterval=30, orient=tk.HORIZONTAL)
        VVIRVRP.pack(side="left", padx=5, pady=5)
        tk.Label(row3, text="Reaction Time (s)").pack(side="left", padx=29, pady=5)
        VVIRRT = tk.Scale(row3, from_=1, to=30, length=300, tickinterval=2, orient=tk.HORIZONTAL)
        VVIRRT.pack(side="left", padx=5, pady=5)
        tk.Label(row4, text="Recovery Time(s)").pack(side="left", padx=30, pady=5)
        VVIRRCT = tk.Scale(row4, from_=5, to=30, length=300, tickinterval=2, orient=tk.HORIZONTAL)
        VVIRRCT.pack(side="left", padx=5, pady=5)
        tk.Label(row5, text="Response Factor").pack(side="left", padx=32, pady=5)
        VVIRRF = tk.Scale(row5, from_=1, to=16, length=300, tickinterval=1, orient=tk.HORIZONTAL)
        VVIRRF.pack(side="left", padx=5, pady=5)
        tk.Label(row11, text="Activity Threshold").pack(side="left", padx=28, pady=5)
        ...
        tk.Label(row5, text="Atrial Amplitude (V)").pack(side="left", padx=20, pady=5)
        ...
        tk.Label(row5, text="Response Factor").pack(side="left", padx=37, pady=5)
        ...
        DDDRMSR.pack(side="left", padx=5, pady=0)
        tk.Label(row4, text="Fixed AV Delay (ms)").pack(side="left", padx=25, pady=5)
        DDDRFAVD = tk.Scale(row4, from_=70, to=300, length=300, tickinterval=20, orient=tk.HORIZONTAL)
        DDDRFAVD.pack(side="left", padx=5, pady=0)
        ...
        tk.Label(row7, text="Atrial Pulse Width (ms)").pack(side="left", padx=20, pady=5)
        DDDRAPW = tk.Scale(row7, from_=1, to=10, length=300, tickinterval=1, orient=tk.HORIZONTAL)
        DDDRAPW.pack(side="left", padx=5, pady=0)
        tk.Label(row8, text="Ventricular Pulse Width (ms)").pack(side="left", padx=5, pady=5)
        DDDRVPW = tk.Scale(row8, from_=1, to=10, length=300, tickinterval=1, orient=tk.HORIZONTAL)
        DDDRVPW.pack(side="left", padx=5, pady=0)
        tk.Label(row1, text="Artial Sensitivity (mV)").pack(side="left", padx=20, pady=5)
        DDDRAS = tk.Scale(row1, from_=0.5, to=3.3, resolution=0.1, length=300, tickinterval=0.3, orient=tk.HORIZONTAL)
        DDDRAS.pack(side="left", padx=5, pady=0)
        tk.Label(row2, text="Ventricular Sensitivity (mV)").pack(side="left", padx=5, pady=5)
        DDDRVS = tk.Scale(row2, from_=0.5, to=3.3, resolution=0.1, length=300, tickinterval=0.3, orient=tk.HORIZONTAL)
        DDDRVS.pack(side="left", padx=5, pady=0)
        tk.Label(row3, text="ARP (ms)").pack(side="left", padx=52, pady=5)
        ...
        tk.Label(row4, text="VRP (ms)").pack(side="left", padx=52, pady=5)
        DDDRVRP = tk.Scale(row4, from_=150, to=500, length=300, tickinterval=30, orient=tk.HORIZONTAL)
        DDDRVRP.pack(side="left", padx=5, pady=5)
        tk.Label(row5, text="PVARP (ms)").pack(side="left", padx=45, pady=5)#########################################
